...
const DealersProductList = ({ onNewProductClick }) => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const salonId = localStorage.getItem("salon_id");
        const response = await axios.get(`${BASE_URL}/api/dealProducts`, {
          headers: {
            salon_id: salonId,
          },
        });
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const salonId = localStorage.getItem("salon_id");
        const response = await axios.get(`${BASE_URL}/api/dealerProducts`, {
          headers: {
            salon_id: salonId,
          },
        });
...
export default DealersProductList;
