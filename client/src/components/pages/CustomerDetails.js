...
const CustomerDetails = ({ selectedCustomer }) => {
  ...
  const [, setCurrentBillingList] = useState([]);
  ...
  const fetchBillingData = useCallback(async () => {
    ...
    try {
      const response = await Axios.get(
        `${BASE_URL}/api/customers/${selectedCustomer.id}/billing`
      );
      setCurrentBillingList(response.data);
    } catch (error) {
  ...
  // Fetch billing data when the component mounts or when selectedCustomer changes
  useEffect(() => {
    fetchBillingData();
  }, [selectedCustomer, fetchBillingData]);
  ...
  const handleEditSave = async (editedCustomer) => {
    ...
    try {
      await fetch(`${BASE_URL}/api/customers/${editedCustomer._id}`, {
        method: "PUT",
        headers: {
  ...
  const handlePrintBillDetails = () => {
    if (showBillDetails && selectedBillDetails) {
      // console.log('Selected Bill Details:', selectedBillDetails);

      // Retrieve the logged-in user's name from localStorage
      const createdByName =
        localStorage.getItem("employeeName") ||
        localStorage.getItem("adminName");
      // const createdName = localStorage.getItem('employeeName') || localStorage.getItem('adminName');
            ...
            <div style=" display: flex; justify-content: center;">
              <div class="popup-content">
                ...
                <div style="display: flex; flex-direction: row; margin-bottom: -10px;">
                  <p class="popup-details">Bill Number</p> :&nbsp;&nbsp;&nbsp;&nbsp; ${
                    selectedBillDetails.billNumber
                  }
                </div>
                <div style="display: flex; flex-direction: row; margin-bottom: -10px;">
                  <p class="popup-details">Branch Name</p> :&nbsp;&nbsp;&nbsp;&nbsp; ${
                    selectedBillDetails.branchName
                  }
                </div>
                <div style="display: flex; flex-direction: row; margin-bottom: -10px;">
                  <p class="popup-details">Branch ID</p> :&nbsp;&nbsp;&nbsp;&nbsp; ${
                    selectedBillDetails.branchId
                  }
                </div>
                <div style="display: flex; flex-direction: row; margin-bottom: -10px;">
                  <p class="popup-details">Customer Name</p> :&nbsp;&nbsp;&nbsp;&nbsp; ${
                    selectedBillDetails.name
                  }
                </div>
                <div style="display: flex; flex-direction: row; margin-bottom: -10px;">
                  <p class="popup-details">Customer Id</p> :&nbsp;&nbsp;&nbsp;&nbsp; ${
                    selectedCustomer.customerId
                  }
                </div>
                <div style="display: flex; flex-direction: row; margin-bottom: -10px;">
                  <p class="popup-details">Bill Date</p> : &nbsp;&nbsp;&nbsp;&nbsp;${formatDate(
                    selectedBillDetails.date
                  )}
                </div>
                <div style="display: flex; flex-direction: row; margin-bottom: -10px;">
                  <p class="popup-details">Service Discount %</p> :&nbsp;&nbsp;&nbsp;&nbsp; ${
                    selectedBillDetails.serviceDiscountPercent
                  }
                </div>
                <div style="display: flex; flex-direction: row; margin-bottom: -10px;">
                  <p class="popup-details">Item Discount %</p> :&nbsp;&nbsp;&nbsp;&nbsp; ${
                    selectedBillDetails.itemDiscountPercent
                  }
                </div>
                <div style="display: flex; flex-direction: row; margin-bottom: -10px;">
                  <p class="popup-details">Service GST %</p> :&nbsp;&nbsp;&nbsp;&nbsp; ${
                    selectedBillDetails.serviceGstPercent
                  }
                </div>
                
                <div style="display: flex; flex-direction: row; margin-bottom: -10px;">
                  <p class="popup-details">Service Final</p> :&nbsp;&nbsp;&nbsp;&nbsp; ${
                    selectedBillDetails.serviceFinalTotal
                  }
                </div>
                <div style="display: flex; flex-direction: row; margin-bottom: -10px;">
                  <p class="popup-details">Item Final</p> :&nbsp;&nbsp;&nbsp;&nbsp; ${selectedBillDetails.itemFinalTotal.toFixed(
                    2
                  )}
                </div>
                <div style="display: flex; flex-direction: row; margin-bottom: -10px;">
                  <p class="popup-details">Payment Method</p> :&nbsp;&nbsp;&nbsp;&nbsp; ${
                    selectedBillDetails.paymentMethod
                  }
                </div>
                <div style="display: flex; flex-direction: row; margin-bottom: -10px;">
                  <p class="popup-details">Amount Paid</p> :&nbsp;&nbsp;&nbsp;&nbsp;₹ ${selectedBillDetails.totalAmount}/-
                </div>
                ...
                <table class="popup-table">
                  <thead>
                    <tr>
                      ...
                      <th class="th89">Price</th>
                      <th class="th89">Employee</th>
                    </tr>
                  </thead>
                  <tbody>
                    ${selectedBillDetails.services
                      ...
                      <tr>
                        ...
                        <td class="td89 td88">${service.employee}</td>
                      </tr>
                    `
                      )
                      .join("")}
                ...
                <!-- Display Bill Generated By -->
                <div style="display: flex; flex-direction: row; margin-bottom: -10px;">
                  <p class="popup-details">Bill Generated By</p> :&nbsp;&nbsp;&nbsp;&nbsp; ${createdByName}.toFixed(2)
                </div>
              </div>
            </div>
          </body>
  ...
  return (
    <div className="main-empp">
      {displayComponent === "customerDetails" ? (
        <>
          <div className="customer-container123121">
            {/* <div className="customer-container11"></div> */}

            <h5 className="heading234">Customers</h5>

            <div className="mdiv">
              {/* <div className="sdiv1"></div> */}
              <div className="sdiv2">
                            ...
                            <ol className="ol897">
                              {appointment.selectedServices.map(
                                (service, serviceIndex) => (
                                  <li className="li78" key={serviceIndex}>
                                    {service}
                                  </li>
                                )
                              )}
                ...
                <table className="customer-table11">
                  <thead className="thead87">
                    <tr>
                      ...
                      <th className="customer-table11-th">Generated By</th>
                      <th className="customer-table11-th">Action</th>
                    </tr>
                  </thead>
                  <tbody className="thead87">
                    {currentBillingList
                      ...
                      .map((bill, index) => (
                        <tr key={index}>
                          ...
                          <td className="customer-table11-td">{bill.name}</td>
                          <td className="customer-table11-td1">
            ...
            <div className="popup-overlay">
              <div className="popup-content">
                ...
                <div className="total-details">
                  <div className="flexchange4455">
                    <p className="popup-details">Service Discount %</p> :
                    &nbsp;&nbsp; &nbsp;&nbsp;
                    {selectedBillDetails.serviceDiscountPercent}
                  </div>
                  <div className="flexchange4455">
                    <p className="popup-details">Item Discount %</p> :
                    &nbsp;&nbsp; &nbsp;&nbsp;
                    {selectedBillDetails.itemDiscountPercent}
                  </div>
                  <div className="flexchange4455">
                    <p className="popup-details">Service GST %</p> :
                    &nbsp;&nbsp; &nbsp;&nbsp;
                    {selectedBillDetails.serviceGstPercent}
                  </div>
                  <div className="flexchange4455">
                    <p className="popup-details">Service Final Total</p> :
                    &nbsp;&nbsp; &nbsp;&nbsp;
                    {selectedBillDetails.serviceFinalTotal}
                  </div>
                  <div className="flexchange4455">
                    <p className="popup-details">Item Final Total</p> :
                    &nbsp;&nbsp; &nbsp;&nbsp;
                    {selectedBillDetails.itemFinalTotal.toFixed(2)}
                  </div>
                  <div className="flexchange4455">
                    <p className="popup-details">Payment Method</p> :
                    &nbsp;&nbsp; &nbsp;&nbsp;
                    {selectedBillDetails.paymentMethod.replace(/_/g, " ")}
                  </div>

                  <h5 className="total-amount">
                    Total Amount in RS :{" "}
                    {selectedBillDetails.totalAmount.toFixed(2)} /-
                  </h5>
                </div>
                ...
                <div className="flexchange4455">
                  <p className="popup-details">Bill Generated By</p> :
                  &nbsp;&nbsp; &nbsp;&nbsp;{selectedBillDetails.createdByName}
                </div>
              </div>
            </div>
          )}
